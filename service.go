...
// 规则：
//   - 周一至周五：仅允许 17:00-20:30 使用
//   - 周六、周日：仅允许 11:00-21:00 使用
//   其余时间关机
...
func doShutdown() {
	cmd := exec.Command("shutdown", "/s", "/t", "60", "/c", "当前处于限制使用时间段（工作日 17:00-20:30，周末 11:00-21:00），电脑将在 60 秒后关机。")
	cmd.Run()
}
